...
def prepare_dataset_and_info_printer(
    main_cfg, selected_scene, info_printer, is_train=True
):
    ...
    main_cfg.planner.SLAMData_dir = os.path.join(
        main_cfg.dirs.data_dir, main_cfg.general.dataset, main_cfg.general.scene
    )
